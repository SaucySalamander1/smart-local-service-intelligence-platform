...
export default function ResultPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-16">
      ...
      {/* ── THREAT BANNER ── */}
      <div className={`${config.headerBg} text-white py-6 px-6`}>
        {/* Back button */}
                  ...
                  <div className="flex items-stretch">
                    <div className="flex-shrink-0 bg-gray-100 overflow-hidden" style={{ width: "130px" }}>
                      {stepImages[step.stepNumber] ? (
                        ...
                        <div className="w-full flex items-center justify-center bg-blue-50" style={{ minHeight: "110px" }}>
                          {imagesLoading
        ...
        {isMidHigh && (
          <div className="bg-red-50 border-2 border-red-200 rounded-2xl overflow-hidden">
            ...
            <div className="p-4 space-y-3">
              <button onClick={() => navigate("/emergency-workers", { state: { category, area: "" } })}
              ...
              <button onClick={() => navigate("/customer/browse-workers", { state: { preCategory: category } })}
                className="w-full bg-blue-600 text-white py-4 rounded-xl font-bold hover:bg-blue-700 transition text-sm">
                👷 Browse Workers
              </button>
              <button onClick={() => navigate("/post-job", { state: { category, diagnosis } })}
